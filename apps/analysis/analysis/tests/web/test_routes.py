...
def test_stats_request_model_with_split_variables() -> None:
    ...
    request = StatsRequest(
        variables=[StatsVariable(variable="test_var")],
...
def test_stats_endpoint_split_variable_logic(
    mock_stats_service_class,  # noqa: ANN001
    mock_get_variable,  # noqa: ANN001
    mock_read_df,  # noqa: ANN001
    mock_get_dataset,  # noqa: ANN001
) -> None:
    ...
    # In reality we'd need to set up the full FastAPI context
    # But we can verify that the StatisticsService
