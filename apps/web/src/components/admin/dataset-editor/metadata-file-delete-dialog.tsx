...
export function MetadataFileDeleteDialog({ datasetId, fileId, fileName, onDeleted }: MetadataFileDeleteDialogProps) {
  ...
  const handleDelete = async () => {
    try {
      setIsDeleting(true);
      const response = await fetch(`/api/datasets/${datasetId}/metadata-files/${fileId}`, {
        method: "DELETE",
      });
