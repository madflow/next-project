...
export function AllowedStatisticsSelector({
  ...
  const handleSave = async () => {
    ...
    // Validation: value range min must be <= max when both are provided
    ...
    try {
      ...
      // Only include valueRange if it's a scale variable with mean enabled and values are provided
      if (showValueRange && (valueRange.min !== undefined || valueRange.max !== undefined)) {
